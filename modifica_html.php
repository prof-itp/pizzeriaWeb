    ...
    <?php
        ...
        if( $result= $conn->query($sql)){
            if( $result->num_rows > 0){
                ...
                echo '
                    <form action="modifica.php" method="post" enctype="multipart/form-data" style="text-align:center; background-color:lightblue; border: 2px solid blue; border-radius:20px; margin:auto; width:25%;">
                        <p> libro: ( id - titolo)
            ...
            }else echo '<br> <h2 style="text-align:center;">Nessun libro da modificare</h2>';
